...
class Preferences {
  ...
  Future<bool?> get firstTimeLoginSetting async => (await _sharedPreferences)
      .getBool(Settings.IS_LOGIN_VERY_FIRST_TIME_SETTING);
  ...
  // String? get latestPass =>
  //     sharedPreferences.getString(Settings.LOGIN_LATEST_PASSWORD);
