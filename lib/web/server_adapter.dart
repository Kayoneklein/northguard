...
import 'package:northguard/model/geocode_result.dart';
...
import 'package:northguard/model/login.dart';
import 'package:northguard/model/login_result.dart';
...
import 'package:northguard/model/share_result.dart';
  ...
  Future<void> login({
    ...
    try {
      ...
      try {
        ...
        print('Error from the local db service in the login route - $err');
      }
